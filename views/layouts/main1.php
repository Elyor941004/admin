    ...
    <div class="container-fluid">
        ...
        <div id="logo" class="pull-left">
            <h1><a href="<?=Url::to('') ?>" class="scrollto">
                    <img src="img/shablon/logo.png" height="50" width="50" style="border-radius: 50%; margin-top: -7px;"/></a></h1>
        ...
        <nav id="nav-menu-container">
            <ul class="nav-menu">
                ...
                <li class="menu-has-children"><a href="<?=Url::to('about-studio/about_us') ?>">О студии</a>
                    <ul>
                        <li><a href="<?=Url::to('about-studio/reviews') ?>">Отзывы</a></li>
                        <li><a href="<?=Url::to('about-studio/commands') ?>">Наша команда</a></li>
                        <li><a href="<?=Url::to('about-studio/partners') ?>">Наши партнеры</a></li>
                        <li><a href="<?=Url::to('about-studio/vacancies') ?>">Вакансии</a></li>
                    </ul>
                </li>
                <li class="menu-has-children"><a href="#services">Услуги</a>
                    <ul>
                ...
                <li><a href="<?=Url::to('projects/developmentsites') ?>">Проeкты</a>
                </li>
                <li><a href="<?=Url::to('prices/prices') ?>">Стоимость</a></li>
                <li><a href="<?=Url::to('../contacts/contact') ?>">Контакты</a></li>
                <li><a href="#"></a>
                    <button type="button" class="btn p-2 d-md-block d-none" onclick="openNav()" style="color: #FFFFFF; background-color: rgba(0,0,0,0.9); width: 150px; margin-top: -33px;">Заказат</button>
                </li>
