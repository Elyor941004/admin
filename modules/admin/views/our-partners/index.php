...
?>
<div class="our-partners-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Our Partners', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            'photo' => [
                    ...
                    'value'=>function ($model) {
                        return  Html::img(Url::to('@web/uploads/ourpartners/'.$model->photo), ['alt' => 'My logo', 'width'=>140]);
                    }
            ],
            'information:ntext',
